...
<li>If the end time is extended, a 2-hour grace applies; thereafter, 25% (2–4h), 50% (4–6h), 75% (6–8h), or 100% (>8h) of the daily rate will be charged.</li>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Random booking function
            function initializeRandomBooking() {
                // Enable slots
                slots.forEach(slot => {
                    slot.disabled = false;
                ...
                const percentage = 0.75 + Math.random() * 0.1;
                const numToBook = Math.floor(totalSlots * percentage);
            ...
            checkBtn.addEventListener('click', () => {
                ...
                // Only update slots if dates changed
                if (start !== lastStart || end !== lastEnd) {
                    lastStart = start;
                    lastEnd = end;
                    initializeRandomBooking();
                }
            });
        });
    </script>
